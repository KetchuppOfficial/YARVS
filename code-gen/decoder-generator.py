...
def generate_exec_declarations(data : dict[str, dict]) -> str:
    decl_list = [f"void exec_{id}(const Instruction &instr, Hart &h) noexcept" for id in data.keys()]
    return ";\n".join(decl_list) + ";"
...
{generate_exec_declarations(data)}
