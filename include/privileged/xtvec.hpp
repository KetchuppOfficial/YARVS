...
public:
    ...
    constexpr DoubleWord get_base() const noexcept { return get_bits<63, 2>(value_); }
    constexpr void set_base(DoubleWord base) noexcept { value_ = set_bits<63, 2>(value_, base); }
